...
- [completed] Finish `v0.5.0` release prep with release notes, public API/rustdoc validation,
  deterministic `just ci`, and documented live-e2e restricted-proxy caveat.
